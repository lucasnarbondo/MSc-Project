...
legend('Demand+Exportation','Wind+Solar+Biomass','Hydro','Thermal Production','Storage Level','Wind Previously Curtailed','Location','northwest','Interpreter','latex')
grid
...
baseFileName =  sprintf("All2017Dry-Case1-1.pdf");
