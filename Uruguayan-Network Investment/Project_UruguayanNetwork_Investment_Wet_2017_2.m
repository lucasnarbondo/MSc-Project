...
load GenerationAndDemandData_Wet_2017_2
...
for i=1:NumberBuses
    ...
    if ThermalAvg(k) > 0
        ...
        UpperBound=[UpperBound;WindBus(i)*2.8];
    end
    end
end
...
for i=1:NumberBuses
    ...
    if ThermalAvg(k) > 0
        UpperBound=[UpperBound;0];
    elseif 9.45-SaltoGrandeAvg(k)>0
...
legend('Demand+Exportation','Wind+Solar+Biomass','Hydro','Thermal Production','Storage Level','Wind Previously Curtailed','SG Previously Curtailed','RN Previously Curtailed','Location','northeast','Interpreter','latex')
grid
...
baseFileName =  sprintf("All2017Wet-Case2.pdf");
...
set(gcf, 'Color', 'w');
folder = 'C:\Users\lucas\Documents\Imperial College\Project\Uruguayan Network Investment\Images';
baseFileName =  sprintf("ChargeandDischargeWet2017-Case2.pdf");
fullFileName = fullfile(folder, baseFileName);
export_fig(fullFileName);
...
legend('Thermal pre-battery','Thermal post-battery','Location','northeast','Interpreter','latex')
xticks([12 36 60 84 108 132 156])
xticklabels({'Day 1','Day 2','Day 3','Day 4','Day 5','Day 6','Day 7'})
xtickangle(45)
ylabel('Energy (MWh)','Color','k')
...
set(gcf, 'Color', 'w');
folder = 'C:\Users\lucas\Documents\Imperial College\Project\Uruguayan Network Investment\Images';
baseFileName =  sprintf("ThermalPrePostWet2017-Case2.pdf");
fullFileName = fullfile(folder, baseFileName);
export_fig(fullFileName);
